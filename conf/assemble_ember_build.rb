...
def core_tree_hash
+  # As YunoHost does not use git, the default command will fail. Discourse only need the value to write it in app/assets/javascripts/discourse/BUILD_INFO.json.
+  # It could be watsever, so we use a fixed string.
+  "12345678987654321"
end
